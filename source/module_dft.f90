...
MODULE dft
	...
	SUBROUTINE inizializza_dft()
		...
		IF (iniz_dft) STOP 'dati_dft giá inizializzat [ module_dft.f90 > inizializza_dft ]'
	...
	SUBROUTINE run_quantum_espresso()
		...
		IF (.NOT. iniz_dft) STOP 'Non hai inizializzato dati_dft [ module_dft.f90 > run_quantum_espresso ]'
	...
	SUBROUTINE genera_file_out_xml_sh()
		...
		IF (.NOT. iniz_dft) STOP 'Non hai inizializzato dati_dft [ module_dft.f90 > genera_file_out_xml_sh ]'
	...
	SUBROUTINE genera_scf_in(L,N,x)
		...
		IF (.NOT. iniz_dft) STOP 'Non hai inizializzato dati_dft [ module_dft.f90 > genera_scf_in ]'
	...
	SUBROUTINE chiudi_dft()
		...
		IF (.NOT. iniz_dft) STOP 'Non hai inizializzato dati_dft [ module_dft.f90 > chiudi_dft ]'
